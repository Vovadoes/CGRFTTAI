...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Расчёт брутто-ставки финансовой операции с учётом инфляции"))
        ...
        self.label_39.setText(_translate("MainWindow", "<html><head/><body><p>Введите реальную доходность:</p></body></html>"))
        self.label_41.setText(_translate("MainWindow", "<html><head/><body><p>i</p></body></html>"))
