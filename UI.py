...
class Variables:
    ...
    def load(self):
        ...
        self.i = mywindow.is_float(self.main_window.ui.doubleSpinBox_8)
...
class mywindow(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        if DEDUG:
            self.ui.doubleSpinBox_11.setValue(7)  # h
            self.ui.doubleSpinBox_10.setValue(0.25)  # n
            self.ui.doubleSpinBox_8.setValue(22)  # i
